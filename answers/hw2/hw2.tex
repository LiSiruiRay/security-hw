...
\begin{itemize}[leftmargin=*]
  \item Security Text 2025.01.08: RSA/DSA signing practice—hash-then-sign; reasons hashing is required (malleability, efficiency).
\end{itemize}

\subsection*{Selected excerpts (for traceability)}
\begingroup\small
\begin{itemize}[leftmargin=*]
\item Security Text 2025.01.08.txt, around line 75:\\
...
\subsection*{References to provided Notes}
\begin{itemize}[leftmargin=*]
  \item Security Text 2025.01.07: El Gamal signatures; note on per-signature randomness and the danger of nonce reuse.
\end{itemize}

\subsection*{Selected excerpts (for traceability)}
\begingroup\small
\begin{itemize}[leftmargin=*]
\item Security Text 2025.01.07.txt, around line 205:\\
...
\subsection*{References to provided Notes}
\begin{itemize}[leftmargin=*]
  \item Security Text 2025.01.06: Diffie–Hellman, decisional vs computational assumptions.
\end{itemize}

\subsection*{Selected excerpts (for traceability)}
\begingroup\small
\begin{itemize}[leftmargin=*]
\item Security Text 2025.01.06.txt, around line 205:\\
Observe that Bob can simply publish his key share $g^b$ (mod p) in advance... public key, decisional/computational variants discussed in class materials.
\end{itemize}
\endgroup
